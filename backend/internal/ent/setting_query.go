...
func (_q *SettingQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *SettingQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *SettingQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *SettingQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *SettingQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *SettingQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SettingQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(setting.Table, setting.Columns, sqlgraph.NewFieldSpec(setting.FieldID, field.TypeUint))
	_spec.From = _q.sql
