...
func (Profile) Fields() []ent.Field {
	return []ent.Field{
		...
		field.JSON("security_settings", map[string]any{}).Optional(),
		field.JSON("network_config", map[string]any{}).Optional(),
		field.JSON("restrictions", map[string]any{}).Optional(),
		field.JSON("content_filter", map[string]any{}).Optional(),
		field.JSON("compliance_rules", map[string]any{}).Optional(),
		field.JSON("payloads", map[string]any{}).Optional(),
