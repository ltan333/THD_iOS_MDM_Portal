...
func (_q *AlertRuleQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *AlertRuleQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *AlertRuleQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *AlertRuleQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *AlertRuleQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *AlertRuleQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AlertRuleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(alertrule.Table, alertrule.Columns, sqlgraph.NewFieldSpec(alertrule.FieldID, field.TypeUint))
	_spec.From = _q.sql
