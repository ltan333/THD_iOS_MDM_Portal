...
var (
	...
	PayloadPropertyDefinitionsColumns = []*schema.Column{
		...
		{Name: "payload_type", Type: field.TypeString},
		{Name: "payload_variant", Type: field.TypeString, Default: ""},
		...
		{Name: "presence", Type: field.TypeString, Default: "optional"},
		...
		{Name: "supported_os", Type: field.TypeJSON, Nullable: true},
		{Name: "conditions", Type: field.TypeJSON, Nullable: true},
		{Name: "order_index", Type: field.TypeInt, Default: 0},
		{Name: "yaml_source_file", Type: field.TypeString, Nullable: true},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true},
	}
	...
	PayloadPropertyDefinitionsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "payloadpropertydefinition_payload_type_payload_variant_key",
				Unique:  true,
				Columns: []*schema.Column{PayloadPropertyDefinitionsColumns[1], PayloadPropertyDefinitionsColumns[2], PayloadPropertyDefinitionsColumns[3]},
			},
			{
				Name:    "payloadpropertydefinition_payload_type_payload_variant_order_index",
				Unique:  false,
				Columns: []*schema.Column{PayloadPropertyDefinitionsColumns[1], PayloadPropertyDefinitionsColumns[2], PayloadPropertyDefinitionsColumns[17]},
			},
			{
				Name:    "payloadpropertydefinition_payload_type_payload_variant_is_nested",
				Unique:  false,
				Columns: []*schema.Column{PayloadPropertyDefinitionsColumns[1], PayloadPropertyDefinitionsColumns[2], PayloadPropertyDefinitionsColumns[12]},
			},
			{
				Name:    "payloadpropertydefinition_payload_type",
				Unique:  false,
				Columns: []*schema.Column{PayloadPropertyDefinitionsColumns[1]},
			},
		},
	}
