...
func (_q *AlertQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *AlertQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *AlertQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *AlertQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *AlertQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *AlertQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AlertQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(alert.Table, alert.Columns, sqlgraph.NewFieldSpec(alert.FieldID, field.TypeUint))
	_spec.From = _q.sql
