...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/dep/proxy/{name}/devices/disown": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/dep/proxy/{name}/devices/sync": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
