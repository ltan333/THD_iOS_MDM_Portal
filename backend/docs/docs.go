...
const docTemplate = `{
        ...
        "/v1/payload-property-definitions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search by payload_type, key, description",
                        "name": "search",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Filter by value_type",
                        "name": "value_type",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Sort by field (id,payload_type,key,value_type,created_at)",
                        "name": "sort",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_thienel_go-backend-template_pkg_response.APIResponse-github_com_thienel_go-backend-template_internal_interface_api_dto_ListResponse-github_com_thienel_go-backend-template_internal_interface_api_dto_PayloadPropertyDefinitionResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Payload property definition data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_thienel_go-backend-template_internal_interface_api_dto.CreatePayloadPropertyDefinitionRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github_com_thienel_go-backend-template_pkg_response.APIResponse-github_com_thienel_go-backend-template_internal_interface_api_dto_PayloadPropertyDefinitionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/payload-property-definitions/import": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Apple payload JSON file",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_thienel_go-backend-template_internal_interface_api_dto.UpdatePayloadPropertyDefinitionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_thienel_go-backend-template_internal_interface_api_dto.CreatePayloadPropertyDefinitionRequest": {
            "type": "object",
            "required": [
                "key",
                "payload_type",
        ...
        "github_com_thienel_go-backend-template_internal_interface_api_dto.ListResponse-github_com_thienel_go-backend-template_internal_interface_api_dto_PayloadPropertyDefinitionResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_thienel_go-backend-template_internal_interface_api_dto.PayloadPropertyDefinitionResponse"
                    }
                },
                "limit": {
                    "type": "integer"
        ...
        "github_com_thienel_go-backend-template_internal_interface_api_dto.PayloadPropertyDefinitionResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "github_com_thienel_go-backend-template_internal_interface_api_dto.UpdatePayloadPropertyDefinitionRequest": {
            "type": "object",
            "required": [
                "key",
                "payload_type",
        ...
        "github_com_thienel_go-backend-template_pkg_response.APIResponse-github_com_thienel_go-backend-template_internal_interface_api_dto_ListResponse-github_com_thienel_go-backend-template_internal_interface_api_dto_PayloadPropertyDefinitionResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/github_com_thienel_go-backend-template_internal_interface_api_dto.ListResponse-github_com_thienel_go-backend-template_internal_interface_api_dto_PayloadPropertyDefinitionResponse"
                },
                "error": {
                    "$ref": "#/definitions/github_com_thienel_go-backend-template_pkg_response.Error"
                },
        ...
        "github_com_thienel_go-backend-template_pkg_response.APIResponse-github_com_thienel_go-backend-template_internal_interface_api_dto_PayloadPropertyDefinitionResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/github_com_thienel_go-backend-template_internal_interface_api_dto.PayloadPropertyDefinitionResponse"
